...
*/
  ...
  function push_rent_data() {
    ...
    $qry = "INSERT INTO tbl_rent1 (rent_month, ll_code, rent_amount, rent_status, rent_comment, receipt) VALUES ('$rent_month', '$ll_code', '$rent_amount', '$rent_status', '$rent_comment', '$rent_receipt')";
