(function(){
	...
	cartEditController = function($scope, $q, $rootScope, $filter, $modalInstance, passingValues, cartService, aswaValidationService){
		$scope.passingValues = {};
		...
		$scope.reference					=	{};
		$scope.reference.cartStatus			=	reference.cartStatus;
		$scope.reference.cart				=	reference.cart;
	...
	angular.module('aswa').controller('cartEditController', ['$scope', '$q', '$rootScope', '$filter', '$modalInstance', 'passingValues', 'cartService', 'aswaValidationService', cartEditController]);
